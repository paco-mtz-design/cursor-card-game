...
const ITEM_SPECS = {
  ...
  'Barbed Gauntlets': { type: 'gear_accessory', effect: 'If the wearer is successfully hit by a Brawler or Lancer, flip a coin. On heads, deal 1 damage to the attacker (even if this unit is defeated).' },
  'Wardstone Bracelet': { type: 'gear_accessory', effect: 'You may choose to protect the wearer from all damage and effects of a single attack. Discard immediately if you do so.' },
